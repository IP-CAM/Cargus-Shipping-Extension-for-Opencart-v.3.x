...
var Widget = (function () {
    ...
    Widget.prototype.getListItemContent = function (location) {
        ...
        if (location.MainPicture) {
            content += '<img loading="lazy" src="' + location.MainPicture + '" class="cwmp-popup-location-image" onclick="Widget.instance.showMore(' + location.Id + ')"/>';
        }
        else {
            content +=
        ...
        //#endregion
        //#region more info
        content += '<button class="directions-image-button" type="button" onclick="Widget.instance.showMore(' + location.Id + ')">';
    ...
    Widget.prototype.showMore = function (id) {
        ...
        c += '<button class="cwmp-more-popup-close-button" type="button" onclick="Widget.instance.closeMore()">x</button>';
        c += '</div>';
        if (location.MainPicture) {
